...
class _$_Room implements _Room {
  const _$_Room({required this.success, required this.data});
  ...
  @override
  String toString() {
    return 'Room(success: $success, data: $data)';
  }
...
abstract class _Room implements Room {
  const factory _Room(
      {required final bool success, required final String data}) = _$_Room;
